...
def cli():  # sourcery skip: inline-immediately-returned-variable
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Optionally, date cutoff for templates, YYYY-MM-DD.",
    )
...
if __name__ == "__main__":
    ...
    print("Preprocessing MHCs...")
    df_to_model = make_inputs.preprocess_df(df_to_model)
    print("MHC numbering and seqnn complete.")

    # make AF inputs
    af_inputs = make_inputs.make_inputs(
        df_to_model, date_cutoff=date_cutoff, print_stats=False
    )
