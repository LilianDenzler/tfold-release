...
kalign_binary_path = "/miniconda/envs/tfold-env/bin/kalign"

##########################################################################################################

# folder with processed mmcif files to use as templates
mmcif_dir = f"{tfold_data_dir}/experimental_structures/processed_updated/mmcif"
# folder with pdbs for true structures, for rmsd computations
true_pdb_dir = (
    f"{tfold_data_dir}/experimental_structures/processed_updated/pdb_rotated"
)
...
af_params = {
    "num_ensemble": 1,  # ensembling
    "model_names": (
        "model_1",
    ),  # which AF models to use; monomer models with templates are okay,
